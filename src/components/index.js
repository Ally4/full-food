...
export default class Index extends Component {
  ...
  sendEmail = (e) => {
    ...
    render() {
      ...
      <div className="home__down">
          <div className="home__down--left">
            <h2 className="title">MAKING NEW LIVES GENERATION BETTER</h2>
            <h1 className="title">FULL FOOD</h1>
            <h4 className="title">Life in very precious, especially for the new borns as the will be the future of our world </h4>
          </div>
    ...
    <div className="projects-1" id="projects-1">
      ...
      <Example style={{height: "40px", width: "40px"}}/>
                  ...
                  <div className="col-md-7">
                    <div className="card-body">
                      ...
                      <p className="card-description">
                        Ally is a social-enterpreneur, He has been certified as a nutritionist by Salad Master, with tremendous skills into communication and public speaking he has also an experience in nutritional business,(A LA SOYA, in 50 finalist of THIS NUMBER HAVE FACES ...)
                      </p>
                    </div>
                    <div className="card-footer">
                      <a href="https://www.linkedin.com/in/nengo-ally-617306124/" target="_blank" rel="noreferrer" className="btn btn-just-icon btn-link btn-linkedin"><i className="fa fa-linkedin"></i></a>
                      <a href="https://www.facebook.com/el.ally3/" target="_blank" rel="noreferrer" className="btn btn-just-icon btn-link btn-facebook"><i className="fa fa-facebook-square"></i></a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="card card-profile card-plain">
                <div className="row">
                  ...
                  <div className="col-md-7">
                    ...
                    <div className="card-footer">
                      <a href="https://www.linkedin.com/in/jean-makara-1208b8166/" rel="noreferrer" target="_blank" className="btn btn-just-icon btn-link btn-linkedin"><i className="fa fa-linkedin"></i></a>
                      <a href="https://www.facebook.com/jean.makara" target="_blank" rel="noreferrer" className="btn btn-just-icon btn-link btn-facebook"><i className="fa fa-facebook-square"></i></a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-7">
                    <div className="card-body">
                      ...
                      <p className="card-description">
                        Martin is an expert in the finance and risk evaluation field for over than 10 years, currently she is working with an NGO which helps in looking for funds on medium and small level enterprises for a fast growth and expansion.
                      </p>
                    </div>
                    <div className="card-footer">
                      <a href="https://www.linkedin.com/in/munezero-uwase-martine-55484015b/" target="_blank" rel="noreferrer" className="btn btn-just-icon btn-link btn-linkedin"><i className="fa fa-linkedin"></i></a>
                      <a href="https://www.facebook.com/munezero.martine" target="_blank" rel="noreferrer" className="btn btn-just-icon btn-link btn-facebook"><i className="fa fa-facebook-square"></i></a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-7">
                    <div className="card-body">
                      ...
                      <h6 className="card-category text-muted">Advertisor and marketer</h6>
                      <p className="card-description">
                        Ismael is a digital media person that advertise and market full food so it can get to the public, he has been working in the field of advertising for over than 7 years.
                      </p>
                    </div>
                    <div className="card-footer">
                      <a href="https://www.linkedin.com/in/ismail-saiba-128b28129/" target="_blank" rel="noreferrer" className="btn btn-just-icon btn-link btn-linkedin"><i className="fa fa-linkedin"></i></a>
                      <a href="https://www.facebook.com/ismail.saiba" target="_blank" rel="noreferrer" className="btn btn-just-icon btn-link btn-facebook"><i className="fa fa-facebook-square"></i></a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-7">
                    <div className="card-body">
                      ...
                      <p className="card-description">
                        Asman is a designer and filmmaker that have been very active in these field for the last 5 years, from interviews, adds, short movies to feature movies Asman have been doing great work, he will be helping with designs and short movies on our different shoots and publicities.
                      </p>
                    </div>
                    <div className="card-footer">
                      <a href="https://www.linkedin.com/in/asmani-saiba-2671ab188/" target="_blank" rel="noreferrer" className="btn btn-just-icon btn-link btn-linkedin"><i className="fa fa-linkedin"></i></a>
                      <a href="https://www.facebook.com/asmanisaiba" target="_blank" rel="noreferrer" className="btn btn-just-icon btn-link btn-facebook"><i className="fa fa-facebook-square"></i></a>
                    </div>
                  </div>
                </div>
              </div>
